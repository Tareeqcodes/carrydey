...
export const DEFAULT_PRICING = {
  ...
  minFare:         1500,
  fragilePremium:  200,
  weightPremiums:  { light: 0, medium: 100, heavy: 250, 'very-heavy': 400 },
...
export function parseAgencyPricing(agencyData) {
  ...
  return {
    baseDeliveryFee: Number(agencyData.baseDeliveryFee) || DEFAULT_PRICING.baseDeliveryFee,
    ...
    fragilePremium:  Number(agencyData.fragilePremium)  || DEFAULT_PRICING.fragilePremium,
    weightPremiums:  safeJson(agencyData.weightPremiums, DEFAULT_PRICING.weightPremiums),
    sizePremiums:    safeJson(agencyData.sizePremiums,   DEFAULT_PRICING.sizePremiums),
  };
}
