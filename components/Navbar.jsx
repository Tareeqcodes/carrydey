          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              {user ? (
                <Link
                  href="/dashboard"
                  className="bg-white/95 backdrop-blur-sm border-b border-gray-100 hover:text-white hover:bg-[#3A0A21] transition-colors px-3 py-2 shadow rounded-xl font-medium"
                >
                  Dashboard
                </Link>
              ) : (
