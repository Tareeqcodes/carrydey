    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      ...
      <AnimatePresence>
        {successMessage && (
          ...
          >
            <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl shadow-2xl border border-green-100/50 dark:border-green-900/30 p-5 flex items-center gap-4">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center flex-shrink-0">
        ...
        {error && (
          <motion.div
            ...
            className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-md px-4"
          >
            <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl shadow-2xl border border-red-100/50 dark:border-red-900/30 p-5 flex items-center gap-4">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center flex-shrink-0">
      ...
      <div className="mx-auto px-4 mb-28 lg:px-8 py-8 sm:py-12 max-w-7xl">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 p-1.5 bg-gray-100 dark:bg-white/10 rounded-2xl w-fit">
            {TABS.map((tab) => (
              <button
                key={tab.key}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                  ...
                  <Switch
                    ...
                    className={`${formData.isAvailable ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'} 
                      relative inline-flex h-8 w-14 items-center rounded-full transition-all duration-300 
                      focus:outline-none focus:ring-2 focus:ring-[#3A0A21] focus:ring-offset-2`}
                  >
                    <motion.span
                      layout
                      className={`${formData.isAvailable ? 'translate-x-7' : 'translate-x-1'} 
