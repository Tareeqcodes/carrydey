...
const TrackAgencyDelivery = () => {
  ...
  const recentActivities = [
    {
      id: 1,
      action: 'Delivery #101 completed',
      time: '10 min ago',
      driver: 'Michael Chen',
    },
    {
      id: 2,
      action: 'New delivery request received',
      time: '25 min ago',
      location: 'Downtown',
    },
    {
      id: 3,
      action: 'Driver Sarah started delivery',
      time: '45 min ago',
      delivery: '#102',
    },
    {
      id: 4,
      action: 'Driver David assigned to new delivery',
      time: '1 hour ago',
      delivery: '#103',
    },
  ];
                    ...
                    <p className="font-medium">
                      {
                        activeDeliveries.filter(
                          (d) =>
                            !['delivered', 'pending_assignment'].includes(
                              d.status
                            )
                        ).length
                      }{' '}
      ...
      case 'active':
        return (
          <div className="space-y-6">
            ...
            {/* Pending Assignments */}
            {activeDeliveries.filter((d) => d.status === 'pending_assignment')
              .length > 0 && (
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          {delivery.status === 'assigned' && (
                            <button
                              onClick={() =>
                                updateDeliveryStatus(delivery.id, 'pickup')
                              }
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-4 max-h-[400px] overflow-y-auto">
                    ...
                    {activeDeliveries.filter(
                      (d) =>
                        !['delivered', 'pending_assignment'].includes(d.status)
                    ).length === 0 && (
                    ...
                    {assignmentModal.packageDetails && (
                      <>
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            Payout: {assignmentModal.packageDetails.payout}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            Customer:{' '}
                            {assignmentModal.packageDetails.customerName}
                          </span>
                        </div>
                      </>
                    )}
