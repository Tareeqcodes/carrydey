...
const BrandingSettings = ({
  ...
  const inputClass =
    'w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border-2 border-gray-200 dark:border-white/10 rounded-xl focus:outline-none focus:border-[#00C896] focus:bg-white dark:focus:bg-white/10 transition-all text-gray-900 dark:text-white font-medium placeholder:text-gray-400';
        ...
        <div className="p-8">
          <div className="flex items-center gap-6">
            <div className="relative group">
              {formData.logoUrl ? (
                <div className="w-20 h-20 rounded-2xl border-2 border-gray-200 dark:border-white/10 overflow-hidden bg-white dark:bg-white/5">
                  <img
                ...
                <div className="w-20 h-20 rounded-2xl border-2 border-dashed border-gray-300 dark:border-white/20 flex items-center justify-center bg-gray-50 dark:bg-white/5">
            ...
            <div className="flex-1">
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-[#00C896] text-white rounded-xl font-semibold transition-all disabled:opacity-50"
              >
                {uploadingLogo ? (
                  <>
      ...
      >
        <div className="p-8">
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {COLOR_PRESETS.map((preset) => (
                  <motion.button
                    ...
                    className="group relative p-4 bg-gray-50 dark:bg-white/5 rounded-xl border-2 border-gray-200 dark:border-white/10 hover:border-gray-400 dark:hover:border-white/30 transition-all"
                  >
                ...
                <div key={colorKey}>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-16 h-16 rounded-xl border-2 border-gray-200 dark:border-white/10 cursor-pointer"
                    />
                    <input
                      type="text"
                      value={formData.brandColors[colorKey]}
            ...
            {/* Preview */}
            <div className="p-6 rounded-2xl border-2 border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  {formData.logoUrl ? (
                    <div className="w-12 h-12 bg-white dark:bg-gray-800 rounded-xl p-1.5">
                      <img
                        src={formData.logoUrl}
                        alt="Preview"
            ...
            <motion.button
              ...
              disabled={saving}
              className="w-full py-3.5 px-6 bg-[#00C896] text-white rounded-xl font-semibold hover:shadow-xl hover:shadow-[#00C896]/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {saving ? (
                <>
                  <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
