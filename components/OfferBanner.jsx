...
const OfferBanner = ({
  ...
  const timerColor =
    clampedCount > 10 ? '#FF6B35'
    : clampedCount > 5  ? '#f59e0b'
    : '#ef4444';
      ...
      <div className="fixed inset-0 z-50 flex items-end justify-center">
        ...
        <div className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-t-3xl p-6 shadow-2xl">
          <div className="flex flex-col items-center gap-3 py-4">
            ...
            <p className="font-black text-lg text-gray-900 dark:text-white">Offer Accepted!</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Loading your delivery...</p>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ background: '#3A0A21' }}>
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">Respond before time runs out</p>
              </div>
            </div>
            <button
              onClick={onDecline}
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <div className="relative w-20 h-20 flex-shrink-0">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 80 80">
                <circle cx="40" cy="40" r="36" stroke="#e5e7eb" strokeWidth="5" fill="none" className="dark:stroke-zinc-700" />
                <circle
                  cx="40"
                  cy="40"
                  r="36"
