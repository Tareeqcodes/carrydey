...
const HINTS = [
  ...
  { max: 2200,     text: 'Competitive — good chance of quick pickup',   color: '#00C896' },
  { max: Infinity, text: 'Premium — couriers will prioritise you',      color: '#00E5AD' },
];
...
export default function FareNegotiation() {
  ...
  return (
    <section className="py-20 px-4 md:px-6 bg-[#111111]">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <h2
            className="text-[28px] md:text-[38px] font-black text-white leading-[1.08] tracking-[-0.02em] mb-5"
            style={{ fontFamily: 'Fraunces, Georgia, serif' }}
          >
            The marketplace where{' '}
            <span className="text-[#00C896] italic">you</span>{' '}
            name the price.
          </h2>
          <p className="text-[14px] font-medium text-white/50 leading-[1.75] mb-8 max-w-md">
            ...
            {[
              ...
              <div key={title} className="flex items-start gap-4">
                <div
                  ...
                  style={{ background: 'rgba(0,200,150,0.12)', border: '0.5px solid rgba(0,200,150,0.25)' }}
                >
        ...
        {/* ── Right: live mockup ── */}
        <div className="rounded-2xl p-6 bg-[#1A1A1A] border border-[#2E2E2E]">
          <p className="text-[10px] font-bold text-white/25 uppercase tracking-[0.12em] mb-5">
          ...
          <div className="mb-6">
            ...
            {/* Custom track */}
            <div className="relative h-1.5 rounded-full mb-1" style={{ background: 'rgba(255,255,255,0.08)' }}>
              <div
                className="absolute h-full rounded-full transition-all"
                style={{ width: `${slider}%`, background: '#00C896' }}
              />
              <div
                className="absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-[#111111] border-2 border-[#00C896] pointer-events-none"
                style={{ left: `calc(${slider}% - 8px)` }}
              />
              <input
                type="range"
                min={0} max={100} value={slider}
            ...
            <div className="flex justify-between">
              <span className="text-[10px] text-white/20 font-medium">₦500</span>
              <span className="text-[10px] font-semibold transition-all" style={{ color: h.color }}>
                {h.text}
              </span>
              <span className="text-[10px] text-white/20 font-medium">₦3,000</span>
            </div>
          </div>
