'use client';
import { Clock, Users, Truck, Package, Zap, ArrowRight } from 'lucide-react'
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  href="/login"
                  className="inline-flex items-center justify-center space-x-2 bg-[#3A0A21] text-white px-6 md:px-8 py-4 rounded-full hover:bg-[#4A0A31] transition-all shadow-lg shadow-[#3A0A21]/20 font-medium text-lg group"
                >
